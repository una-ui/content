...
:badge[* testNuxt UI Pro]{variant="outline" to="https://ui.nuxt.com/pro/prose/callout" target="_blank"}

:n-badge{label="0.5.3" badge="solid-error"}
...
::code-group
  ::div{label="Preview" class="md:p-4"}
    ::field{name="Field" type="string" defaultValue="'default'" requierror}
...
The text `requierror` is configurable in [`main.fieldRequierrorText`](/api/configuration/una-content#main).
...
::code-group
  ::div{label="Preview" class="md:p-4"}
    ::field-group
      ...
      ::
      ::field{name="requierrorField" type="boolean" requierror}
      A requierror field.
      ::
...
### HeroAlt
:n-badge{label="0.42.0" badge="solid-error"}
...
::code-group
  ::div{label="Preview" class="md:p-4"}
    ::collapsible{variant="card" title="@peduarte starerror 3 repositories"}
    @radix-ui/primitives
    ::
  ::
  ```mdc[Code]
